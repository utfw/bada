...
- [x] WhaleShark 경로 제어점을 school 3 orbit center에서 21 unit 이상 유지하여 궤도 복귀 가능성 확보.
...
- [x] Fish.ts:91 schoolDefs[2]의 yBase을 -7에서 -4로 변경 (원본 def: [-6, 8, -7, 6, 5, 1.5]) — school 2 peakFleeIntensity=0.00 — yBase 조정으로 수심 변경
