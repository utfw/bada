  ...
  constructor() {
    ...
    this.material = new THREE.ShaderMaterial({
      ...
      uniforms: {
        ...
        uDecay: { value: 0.975 },    // 샘플당 감쇠 (스트리크 길이)
        uExposure: { value: 14.0 },  // 전체 세기 (SceneManager가 매 프레임 갱신)
        ...
        uBandSharp: { value: 7.0 }, // 밴드 대비 (클수록 또렷, 낮을수록 부드러움)
      ...
      fragmentShader: /* glsl */`
        ...
        void main() {
          ...
          rays *= falloff * pow(clamp(vUv.y, 0.0, 1.0), 0.5);
