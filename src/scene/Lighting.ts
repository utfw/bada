...
export class Lighting {
  ...
  constructor(scene: THREE.Scene) {
    this.scene = scene;
    scene.fog = new THREE.FogExp2(0x0d5fa0, 0.00255);
    scene.background = new THREE.Color(0x0d5fa0);

    this.ambientLight = new THREE.AmbientLight(0x1a6080, 0.15);
