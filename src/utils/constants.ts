...
export const DEFAULT_FOG_DENSITY = 0.00217;
export const DEFAULT_FOG_COLOR = 0x0a2a50;
...
export const BOID_SEPARATION_DIST = 6.0;
...
export const GODRAY_EXPOSURE = 5.5;
...
export const GODRAY_BAND_COUNT = 12.0;
export const GODRAY_BAND_SHARP = 6.0;
export const GODRAY_BAND_STRENGTH = 0.90;
export const GODRAY_VERTICAL_FALLOFF = 0.8;
